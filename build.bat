...
rem snasm68k.exe -emax 0 -p -o ae- s1comb.asm, Sonic_1_SSRG.bin
asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- sonic1.asm, Sonic_1_SSRG.bin
rompad.exe Sonic_1_SSRG.bin 255 0
fixheadr.exe Sonic_1_SSRG.bin