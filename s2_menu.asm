...
;-------------------------------------------------------------------------------                
; Load the Text of the Menu Selection of Phases             
;-------------------------------------------------------------------------------                
                lea     ($FFFF0000), A3
                move.w  #$045F, D1
Offset_0x026B4E:                
                ...
                moveq   #$00, D0
                move.w  #$0009, D1  ; Amount of texts to be charged and position of Sound Test
Menu_Loop_Load_Text:                 
                move.w  (A5)+, D3
                lea     $00(A3, D3), A2
                moveq   #$00, D2
...
;-------------------------------------------------------------------------------                
                moveq   #$0E, D1
                lea     -$0460(A2), A2
Menu_Clear_Act_x: ; Clears the number of acts not used and load the "*" in the Sound Test                          
                move.w  #$0000, (A2)          ; Load " "
                lea     $0050(A2), A2
                ...
                move.w  #$001A, (A2)          ; Load "*"
;-------------------------------------------------------------------------------                
; Load the mapping of the wings where the icons are displayed             
;------------------------------------------------------------------------------- 
...
;-------------------------------------------------------------------------------                
                ...
                clr.w   ($FFFFF7F0).w   
;------------------------------------------------------------------------------- 
                move.w  #$0000, ($FFFFF7B8).w  ; Initializes the tables of the menu animations
                move.w  #$0000, ($FFFFF7B9).w  ; Initializes the counter of the menu animations 
                jsr     Dynamic_Menu           ; Call the routine of animation
;-------------------------------------------------------------------------------                   
                moveq   #$02, D0               
                bsr     Menu_PalLoad1        
                lea     ($FFFFFB40).w, A1
...
Offset_0x026E1C:
                ...
                addq.w  #$01, D0
                cmpi.w  #$0016, D0   ; Notes that the last item in the list
...
Offset_0x026E2C:
                ...
                rts
Offset_0x026E32:
                cmpi.w  #$0015, ($FFFFFF82).w ; if the item is equal to change the functions of left and right 
...
Offset_0x026F28:                
                ...
                move.w  D0, (A6)
Offset_0x026F6C:
                cmpi.w  #$0015, ($FFFFFF82).w  ; If you select the same number of Sound Test
                bne.s   Offset_0x026F78
                bsr     Offset_0x026F7A
Offset_0x026F78:
                rts
Offset_0x026F7A:
                move.l  #$49C60003, ($00C00004) ; Position of the numbers of Sound Test
                move.w  ($FFFFFF84).w, D0
                move.b  D0, D2
                lsr.b   #$04, D0
...
Menu_Code_Not_0xFF: 
                rts               
Code_Debug_Mode: 
                dc.b    $02, $06, $00, $02, $01, $09, $09, $04, $FF
Code_All_Emeralds: 
                dc.b    $01, $03, $03, $07, $FF
;-------------------------------------------------------------------------------                 
Offset_0x027040:
...
Offset_0x027050:
                ...
                add.w   D1, D0
                lea     $00(A1, D0), A1
                move.l  #$4B360003, D0        ; 	Horizontal Position of Icons
                moveq   #$03, D1
                moveq   #$02, D2
                bsr     Menu_ShowVDPGraphics 
...
Menu_Level_Select_Text: 
                dc.b    $0E, _H, _O, _M, _E, _P, _A, _G, _E, __, __, __, __, __, __, __
                dc.b    $0E, _I, _R, _C, __, __, __, __, __, __, __, __, __, __, __, __
                dc.b    $0E, _S, _P, _R, _I, _N, _G, __, _Y, _A, _R, _D, __, __, __, __
                dc.b    $0E, _L, _A, _B, _Y, _R, _I, _N, _T, _H, __, __, __, __, __, __
                dc.b    $0E, _H, _A, _C, _K, _T, _U, _B, _E, __, __, __, __, __, __, __
                dc.b    $0E, _F, _O, _R, _U, _M, _S, __, __, __, __, __, __, __, __, __
                dc.b    $0E, _A, _D, _M, _I, _N, _I, _S, _T, _R, _A, _T, _I, _O, _N, __
                dc.b    $0E, _S, _P, _E, _C, _I, _A, _L, __, _S, _T, _A, _G, _E, __, __
                dc.b    $0E, _E, _N, _D, _I, _N, _G, __, _S, _E, _Q, _U, _E, _N, _C, _E
                dc.b    $0E, _S, _O, _U, _N, _D, __, _D, _E, _B, _U, _G, __, _st,__, __                 
;-------------------------------------------------------------------------------
Wings_Mappings: 
